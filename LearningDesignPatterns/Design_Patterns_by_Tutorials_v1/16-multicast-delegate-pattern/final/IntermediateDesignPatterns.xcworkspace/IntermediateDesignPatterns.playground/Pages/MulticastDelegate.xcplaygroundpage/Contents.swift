...
public class FireStation: EmergencyResponding {
  ...
  public func notifyFire(at address: String) {
    print("Firefighters were notified about a fire at \(address)")
  }
  
  public func notifyCarCrash(at address: String) {
    print("Firefighters were notified about a car crash at \(address)")
  }
}
...
public class PoliceStation: EmergencyResponding {
  ...
  public func notifyFire(at address: String) {
    print("Police were notified about a fire at \(address)")
  }
  
  public func notifyCarCrash(at address: String) {
    print("Police were notified about a car crash at \(address)")
  }
}
...
multicastDelegate.addDelegate(policeStation)
multicastDelegate.addDelegate(fireStation)

multicastDelegate.invokeDelegates { emergencyResponder in
  emergencyResponder.notifyFire(at: "Ray's house!")
}
...
multicastDelegate.invokeDelegates { emergencyResponder in
  emergencyResponder.notifyCarCrash(at: "Ray's garage!")
}
